<template>
  <div class="BlogView">
    <el-tabs v-model="active_name" class="demo-tabs">
      <el-tab-pane label="关注" name="first">
        <a v-for="(item,index) in article_list" :key="index">
          <article-item
      ...
      <el-tab-pane label="自荐" name="fifth">自荐</el-tab-pane>
